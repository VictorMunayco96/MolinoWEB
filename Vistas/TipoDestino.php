            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <input type="hidden" name="IdTipoDestino" id="IdTipoProducto">
                    <input type="text" class="form-control" placeholder="Tipo Destino" name="TipoDestino" id="TipoDestino" required>
                    </div>
                    ...
                    <div class="form-group col-log-6 col-md-6 col-sm-6 col-xs-12">
                    <label>Codigo:</label>
                    <input type="text" name="CodDestino" class="form-control" id="CodDestino" placeholder="Codigo Destino" maxlength="15">
                    </div>
